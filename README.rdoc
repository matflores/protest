= Protest, the simplicity rebel test framework {<img src="https://secure.travis-ci.org/matflores/protest.png?branch=master" alt="Build Status" />}[http://travis-ci.org/matflores/protest]
